...
export class PermissionService {
  ...
  create(createPermissionDto: CreatePermissionDto, createdBy: string): Promise<Permission> {
  ...
  async update(id: string, updatePermissionDto: UpdatePermissionDto, updatedBy: string): Promise<Permission> {
    await this.permissionsRepository.update(id, { ...updatePermissionDto, updatedBy });
